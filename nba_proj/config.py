...
RAG_WEIGHTS = "rag_weights/rag_head_7_vids_bs4_cls_rag_12_epochs.weights.h5"
PROJ_WEIGHTS = 'proj_weights/projection_7_vids_bs4_cls_rag_12_epochs.weights.h5'

CHROMADB_COLLECTION = "rich_embeddings_7_vids_bs4_cls_rag_12_epochs"
...
INCREMENT_CONTRASTIVE_LOSS_BY = 0.05
